<template>
  <div class="page">
    ...
    >
      <div class="clockShow">
        <div class="msg">
          <van-icon name="checked" class="msgicon" />打卡成功
        </div>
        <div>
          <van-row>
            ...
            <van-col span="20">
              <div class="time">
                <van-icon name="clock" class="msgicon" />
        ...
        <div class="closeShow">
          ...
          <van-button plain type="info" @click="show = false">我知道了</van-button>
        </div>
...
export default {
  data() {
    return {
      ...
      zoom: 20,
      centerContent: "超出打卡范围，正在持续定位...", // 提示内容
      centerBool: false, //
                ...
                if (result) {
                  ...
                  if (self.center.lng != "0" && self.center.lat != "0") {
                    var text = {
                      ...
                      // clockposition: 22.283589 + 113.571732,
                      remark: "打卡",
                      longitude: self.center.lng,
                      latitude: self.center.lat
                      // longitude: 113.571732,
                      // latitude: 22.283589
                    };
                    ...
                    self.$http
                      ...
                      .then(response => {
                        ...
                        if (response.data.status) {
                          ...
                          self.show = true;
                          self.getAttendancerecordById();
                          if (self.timer) {
                            clearInterval(self.timer); // 在vue实例销毁钱，清除我们的定时器
                          }
                        } else {
  ...
  beforeMount() {
    this.getAttendancerecordById(); // 获取打卡信息
    var self = this;
    // 全局的this在方法中不能使用，需要重新定义一下
    var geolocation = new BMap.Geolocation();
    // 调用百度地图api 中的获取当前位置接口
